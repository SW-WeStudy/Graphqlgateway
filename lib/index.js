...
const url = 'resources.default.svc.cluster.local';
const port = '8080';
...
const url$2 = 'auth.default.svc.cluster.local';
const port$2 = '3000';
...
const url$3 = 'courses.default.svc.cluster.local';
const port$3 = '8000';
...
const url$4 = 'navigation.default.svc.cluster.local';
...
const url$5 = 'studyroom.default.svc.cluster.local';
const port$5 = '3000';
...
const url$6 = 'adminusers.default.svc.cluster.local';
const port$6 = '5000';
...
const url$7 = 'notifications.default.svc.cluster.local';
...
const url$9 = '18.216.17.168';
const port$9 = '3000';

const URL$11 = `http://${url$9}:${port$9}`;

const resolvers$11 = {
  Query: {
    getTeachers: (_) => {
      return generalRequest(`${URL$11}/teachers`, "GET");
    },
  },
};
