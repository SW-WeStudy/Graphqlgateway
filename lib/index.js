...
const resolvers$9 = {
  Query: {
        LDAPAuthUser: (_, { email, password }) => {
			return generalRequest(`${URL$9}/auth/authuserldap`, 'GET', { email, password })
		},
	},
	Mutation: {
		LDAPCreateUser: (_,{user}) => {
			return generalRequest(`${URL$9}/auth/createuserldap`, 'POST', user)
		},
	}
};

const url$8 = '18.216.17.168';
>>>>>>> master
const port$8 = '3000';
...
=======
    getTeachers: (_) => {
      return generalRequest(`${URL$10}/teachers`, "GET");
    },
  },
>>>>>>> master
};
...
<<<<<<< HEAD
	...
	await next();
=======
	// 	if(que.includes("LDAP") || que.includes("createUser") || que.includes("getTeachers")){
	// 		await next();
	// 	}
	// }
>>>>>>> master
